...
export const authApi = {
  ...
  googleRegisterInfluencer: (payload: Record<string, unknown>) => api.post('/auth/google/register/influencer', payload),
  googleRegisterBrand: (payload: Record<string, unknown>) => api.post('/auth/google/register/brand', payload),
